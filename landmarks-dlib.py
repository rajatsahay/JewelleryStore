...
class FaceAligner:
    ...
    #RotationalMatrix to gurantee correct neck points when head turns (computation intensive, might decrease fps)
...
while True:
    ...
    for face in faces:
        ...
        for n in range(0, 68):
            ...
            #sending neck coords as strings through socket
            str_neck_coords=str([neck_x1,neck_y1,neck_x2,neck_y2])
            try:
                serversocket.connect((host,port))
                serversocket.sendall(str_neck_coords)
